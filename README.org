l'implémentation fonctionne aussi pour les 32 bits, on a fais les tests (on a changé le test_mark.cc pour qu'il soit adapté aux processus 32 bits et 64 bits)
